...
global.stat_upgrade_list=[obj_stat_change_experience_gain,obj_stat_change_fire_rate,obj_stat_change_gadget_fire_rate,obj_stat_change_health,obj_stat_change_jump_height,obj_stat_change_max_ammo,obj_stat_change_movement_speed];
